...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
        ...
        _______,    KC_GRV,     _______,    _______,    _______,    _______,    _______,             _______,    KC_MINS,    KC_EQL,     KC_LBRC,    KC_RBRC,    KC_BSLS,    _______,
    ...
    [_FUNC] = LAYOUT(
        ...
        KC_ESC,     KC_BASE,    KC_GAME,    _______,    _______,    _______,                                     _______,    _______,    _______,    _______,    _______,    _______,
